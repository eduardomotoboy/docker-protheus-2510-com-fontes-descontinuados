...
If Pergunte(cPerg,.T.)
	U_FINRL64C(MV_PAR01,MV_PAR02,MV_PAR03,MV_PAR04)
EndIf
...
User Function FINRL64C(cPar1,cPar2,dPar3,dPar4,cTabela)
...
User Function FINRZ64C(cPar1,cPar2)
