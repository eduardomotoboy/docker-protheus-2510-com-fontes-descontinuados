...
oReport := TReport():New(nomeProg,OemToAnsi(STR0004),cPerg,{|oReport| Pergunte(cPerg,.F.),Iif(U_f240ValC(@aCtbMoeda,@nDivide),ReportPrint(oReport,aCtbMoeda,nDivide),oReport:CancelPrint())},cDesc1+cDesc2+cDesc3)
...
U_CtbOpcaC(@cRetorno1,@cRetorno2,cSayEnt,cPerg1,cPerg2,cF3,nTotRet,cGrupo,cOrdRet1,cOrdRet2)
