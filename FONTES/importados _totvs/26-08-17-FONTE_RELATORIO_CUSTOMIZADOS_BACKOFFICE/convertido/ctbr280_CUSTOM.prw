...
MsAguarde({|| U_CTR280QC(aMeses,mv_par07,mv_par09,mv_par05,mv_par06,mv_par03,mv_par04,aSetOfBook,mv_par11 == 1,cString,oCentroCusto:GetAdvplExp()/*aReturn[7]*/,.F./*lImpAntLP*/,/*dDataLP*/) }, STR0006 )
cAliasCT1 := "TRBTMP"
cAliasCTT := "TRBTMP"
