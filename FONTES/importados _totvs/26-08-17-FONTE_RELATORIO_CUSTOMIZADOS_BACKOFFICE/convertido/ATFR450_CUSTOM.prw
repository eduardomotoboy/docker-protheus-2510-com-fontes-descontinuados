...
//Valida็ใo de aviso/bloqueio do relat๓rio em Release 12.1.2510 e superiores
If lAvpAtf
...
oReport := TReport():New("ATFR450C",cTitulo,cPerg,{|oReport| ATFR450Imp( oReport,aOrd,cTitulo)},STR0004) //"Este relat๓rio irแ imprimir informa็๕es do cแlculo do AVP conforme parโmetros informados"
