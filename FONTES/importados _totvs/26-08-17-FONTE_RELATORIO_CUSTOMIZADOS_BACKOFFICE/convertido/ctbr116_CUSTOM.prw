...
If lImpLivro		  
	...
	MsgMeter({|	oMeter, oText, oDlg, lEnd | ;
				U_Ctb116CC(oMeter,oText,oDlg,lEnd,@cArqTmp,cMoeda,dDataIni,dDataFim,aSetOfBook,cSaldo,cCodPlGer)},;
...
U_Ctbr115C(oMeter,oText,oDlg,lEnd,cMoeda,dDataIni,dDataFim,aSetOfBook,cSaldo,cCodPlGer)        			
