...
MsgMeter({|	oMeter, oText, oDlg, lEnd | ;
			U_CTB395CC(oMeter,oText,oDlg,lEnd,@cArqTmp,cOrctoIni,cOrctoFim,;
...
U_CTB395GC(oMeter,oText,oDlg,lEnd,cArqTmp,cOrctoIni,cOrctoFim,cRevisa1,cRevisa2,cCalend,cMoeda)
